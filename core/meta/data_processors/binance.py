...
from core.meta.data_processors._base import _Base, check_date
...
class Binance(_Base):
    ...
    def get_binance_bars(self, last_datetime, symbol):
        ...
        # Headers para autenticar la solicitud
        headers = {
            "X-MBX-APIKEY": 'fr4Y4BGvkDKMgG9eCm8MjXvI9lzzP2XyQDCenEg0kgPp1QEBL91wKhwd9f2ea90T'
        }

        # Realizar la solicitud con las credenciales
        response = requests.get(self.url, params=req_params, headers=headers)
