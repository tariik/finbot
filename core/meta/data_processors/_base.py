...
from core.config import TIME_ZONE_BERLIN
from core.config import TIME_ZONE_JAKARTA
from core.config import TIME_ZONE_PARIS
from core.config import TIME_ZONE_SELFDEFINED
from core.config import TIME_ZONE_SHANGHAI
from core.config import TIME_ZONE_USEASTERN
from core.config import USE_TIME_ZONE_SELFDEFINED
from core.config_tickers import CAC_40_TICKER
from core.config_tickers import CSI_300_TICKER
from core.config_tickers import DAX_30_TICKER
from core.config_tickers import DOW_30_TICKER
from core.config_tickers import HSI_50_TICKER
from core.config_tickers import LQ45_TICKER
from core.config_tickers import MDAX_50_TICKER
from core.config_tickers import NAS_100_TICKER
from core.config_tickers import SDAX_50_TICKER
from core.config_tickers import SP_500_TICKER
from core.config_tickers import SSE_50_TICKER
from core.config_tickers import TECDAX_TICKER
...
class _Base:
    def __init__(
        ...
        **kwargs,
        ...
        # transferred_time_interval will be supported in the future. self.nonstandard_time_interval: str =
        # self.calc_nonstandard_time_interval()  # transferred time_interval of this processor
        self.time_zone: str = ""
