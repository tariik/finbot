...
class DataProcessor:
    def __init__(
        ...
        if self.data_source == "binance":
            from core.meta.data_processors.binance import Binance
            processor_dict = {self.data_source: Binance}
        elif self.data_source == "ccxt":
            from core.meta.data_processors.ccxt import Ccxt
            processor_dict = {self.data_source: Ccxt}
        elif self.data_source == "yahoofinance":
            from core.meta.data_processors.yahoofinance import Yahoofinance
